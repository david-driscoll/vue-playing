...
namespace Microsoft.AspNetCore.SpaServices.Prerendering
{
    ...
    public class VueRenderTagHelper : TagHelper
    {
        private const string PrerenderModuleAttributeName = "vue-render-module";
        private const string PrerenderExportAttributeName = "vue-render-export";
        private const string PrerenderDataAttributeName = "vue-render-data";
        private const string PrerenderTimeoutAttributeName = "vue-render-timeout";
